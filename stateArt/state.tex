...
\paragraph{\textbf{Spec Explorer}\cite{}} is a Microsoft model-based testing that uses two software modeling languages:
...
The user of Spec Explorer can search throw all possible sequences of methods invocation that not violate the contracts (pre, pos conditions) and
that are relevant to a user-specified set of test properties.
