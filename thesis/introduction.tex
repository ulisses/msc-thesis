...
\new{
With the increasing size and complexity of software systems, modeling techniques related to abstraction and decomposition\cite{struct-analy} of the system has
