...
\newac{RT}{Real Time}
\newac{DSL}{Domain-specific Language}
\newac{TC}{Test Case}
\newac{SB}{Specification-based}
\newac{SBT}{Specification-based Testing}
\newac{SBGT}{Specification-based Generation Testing}
\newac{CB}{Constraint-based}
\newac{CBT}{Constraint-based Testing}
\newac{CBGT}{Constraint-based Generation Testing}
\newac{GB}{Grammar-based}
\newac{GBT}{Grammar-based Testing}
\newac{GBGT}{Grammar-based Generation Testing}
\newac{RB}{Random-based}
\newac{RBT}{Random-based Testing}
\newac{RBGT}{Random-based Generation Testing}
\newac{WBT}{White-box Testing}
\newac{WB}{White-box}
\newac{BBT}{Black-box Testing}
\newac{BB}{Black-box}
\newac{FSA}{Finite State Automaton}
\newac{UT}{Unit Testing}
\newac{UTS}{Unit Tests}
\newac{SCOS}{Satellite Control and Operation System}
\newac{MIB}{Mission Data Base}
\newac{MCS}{Mission Control System}
