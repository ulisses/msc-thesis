...
In a second part of this chapter is presented the main differences between White-box and Black-box testing and
some testing tools approaches are described considering some automatic generation testing techniques and some tools for each technique namely:
...
This kind of projects are generally  expensive, demand considerable amount of time to be completed and have different companies and countries participating.\\
...
of having a software component fail within this level leaves to a major failures propagation in the mission\cite{ecss-q-st-30c}.\\
...
In this section, a study of the most recent approaches that use Specification-based, Constraint-based, Grammar-based and Random-based tests generation
