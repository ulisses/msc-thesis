...
\new{
\section{DO-178/ED-12 Standard for Airborne Systems}
...
leading to the creation of a single standard, some years later in 1985 --- The DO-178/ED-12 Standard: The first
common certification criteria for production of avionics software. This document became a worldwide basis for software
certification in the aviation industry until nowadays. This Standard is
officially recognized as a de facto international standard by the \ac{ISO}.\\
...
software development covered by DO-178/ED-12\cite{avionics} and none of them has been found to provide a complete coverage of Software Development process as DO-178/ED-12 do.
One of the things that these documents defined was the Software Levels\cite{citeulike:4106419}, ie DO-178/ED-12 requires that all systems requirements be mapped
...
DO-178/ED-12 focus is placed with more emphasis in 
...
\cite{ccoverage}
\cite{citeulike:3789144}
\cite{Marick99}
\cite{citeulike:4106419}
\cite{costa_et_al:OASIcs:2012:3523}
%\note{Falar no CO-178-B}\\
%\note{
