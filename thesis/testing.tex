...
\neww{
The code coverage analysis is a technique used in \ac{WBT}, whose goal is to see how the test suite exercises parts of the code.
...
of acessing the quality of the tests and getting a quantitative classification about it is an indirect measure of quality\cite{ccoverage}.
