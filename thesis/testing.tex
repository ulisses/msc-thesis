...
dedicated standards. \ac{ECSS} Disciplines can also be supported by Handbooks
(HB) and Technical Memoranda (TM) as necessary\cite{ecss-s-st-00c}. The disciplines addressed by the ECSS Standards system are given in Figure \ref{fig:ecssdocsstruct}.
