...
\lstnewenvironment{codeN}{\lstset{language=codeTTN}}{}
...
it uses constraint logic programming to generate the Test-cases. pathCrawler executes an instrumented function for each function under test
