...
Here a study of the most recent tools that uses Specification-based or Constraint-based tests generation
...
to provide information to feedback loop\cite{Xie03mutuallyenhancing}
...
A combination of both, symbolic execution from Pex and complex data generation from Korat, will be designed and implemented to
